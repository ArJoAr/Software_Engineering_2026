...
/** Returns event-type colour config that reacts to the active theme. */
const getTypeStyles = (c: ColorTheme): Record<string, TypeStyleConfig> => ({
  class:    { color: c.info,                   bg: c.infoLight,           label: 'Class' },
  exam:     { color: c.primaryRed,             bg: c.primaryRedLight,     label: 'Exam' },
  deadline: { color: c.warning,                bg: c.warningLight,        label: 'Deadline' },
  event:    { color: c.categoryColors.events,  bg: c.categoryBg.events,   label: 'Event' },
